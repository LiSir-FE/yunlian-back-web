    ...
    <div class="wetuc-page-content">
        <div class="breadcrumb-con">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item :to="{ path: '/activityListManagement' }">活动列表</el-breadcrumb-item>
        ...
        <el-form ref="pageInfo" :model="pageInfo" :inline="true" label-width="80px" :rules="rules">
            ...
            <el-form-item label="活动标签" prop="label">
                <el-select v-model="pageInfo.label" multiple :multiple-limit="3" @change="labelChange" placeholder="请选择活动标签" class="wetuc-input-col2 relation" value-key="value">
                    <el-option
            ...
            <el-form-item label="报名人数">
                <el-input-number v-model="pageInfo.showNum" :min="0" placeholder="0为不限制" class="wetuc-input-col2"></el-input-number>
            </el-form-item>
            ...
            <el-form-item label=" " prop="ticketingData" class="wetuc-block">
                <el-table :data="pageInfo.ticketingData" class="wetuc-input-col943">
                    ...
                    <el-table-column label="价格（元）" show-overflow-tooltip align="center" :min-width="180">
                        <template slot-scope="scope">
                            <el-input-number v-model="scope.row.price" :min="0" placeholder="0为免费" class="wetuc-input-col1"></el-input-number>
                        </template>
                    </el-table-column>
                    <el-table-column label="总发售" show-overflow-tooltip align="center" :min-width="180">
                        <template slot-scope="scope">
                            <el-input-number v-model="scope.row.totalNum" :min="0" placeholder="总张数" class="wetuc-input-col1"></el-input-number>
                        </template>
                    </el-table-column>
                    ...
                    <el-table-column label="每人限购" show-overflow-tooltip align="center" :min-width="180">
                        <template slot-scope="scope">
                            <el-input-number v-model="scope.row.limitNum" :min="0" :max="10" placeholder="最多10张" class="wetuc-input-col1"></el-input-number>
                        </template>
                    </el-table-column>
                    ...
                    <el-table-column label="操作" align="right">
                        <template slot-scope="scope">
                            <el-button type="text" icon="el-icon-delete" class="red" size="small" @click.prevent="delTicketingItem(scope.$index)">删除</el-button>
                        </template>
                    </el-table-column>
                </el-table>
            ...
            <el-form-item v-for="(item, index) in tableData2" :key="index" :label="index === 0 ? ' ' : null">
                <el-input class="wetuc-input-col234" :placeholder="item.key" disabled v-model="item.key" v-if="index >= 0 && index <= 1"></el-input>
                ...
                <div v-for="(item, index) in userNewsData">
                    <div style="display: inline-block;position: relative;" v-if="item.type === 'danh'">
                        <el-form-item>
                            ...
                            <el-checkbox v-model="item.must" style="position: absolute;right: 0">必填</el-checkbox>
                            <i class="el-icon-delete red" style="position: absolute;right: -70px;top: 15px;cursor:pointer;" @click.prevent="deteleOptions(1,index)">删除</i>
                        </el-form-item>
                    </div>
                    <div style="display: inline-block;position: relative" v-if="item.type === 'duoh'">
                        <el-form-item>
                            <el-input type="textarea" rows="4" class="wetuc-input-col943" placeholder="多行文本" v-model="item.key"></el-input>
                            <el-checkbox v-model="item.must" style="position: absolute;right: 0">必填</el-checkbox>
                            <i class="el-icon-delete red" style="position: absolute;right: -70px;top: 15px;cursor:pointer;" @click.prevent="deteleOptions(1,index)">删除</i>
                        </el-form-item>
                    </div>
                    <div style="display: inline-block;position: relative" v-if="item.type === 'danx'">
                        <el-input type="textarea" rows="4" class="wetuc-input-col943" placeholder="单选问题" v-model="item.key"></el-input>
                        <el-checkbox v-model="item.must" style="position: absolute;right: 0">必填</el-checkbox>
                        <div v-for="(val, idx) in item.value" :key="idx" style="margin: 5px 0;position: relative">
                            ...
                            <i class="el-icon-edit" style="position: absolute;right: -70px;top: 15px;cursor:pointer;" @click.prevent="addOptions(item.value)" v-if="idx === 0">添加选项</i>
                            <i class="el-icon-delete red" style="position: absolute;right: -70px;top: 15px;cursor:pointer;" @click.prevent="deteleOptions(2,idx)" v-else>删除</i>
                        </div>
                        <i class="el-icon-delete red" style="position: absolute;right: -70px;top: 15px;cursor:pointer;" @click.prevent="deteleOptions(1,index)">删除</i>
                    </div>
                    <div style="display: inline-block;position: relative" v-if="item.type === 'duox'">
                        <el-input type="textarea" rows="4" class="wetuc-input-col943" placeholder="多选问题" v-model="item.key"></el-input>
                        <el-checkbox v-model="item.must" style="position: absolute;right: 0">必填</el-checkbox>
                        <div v-for="(val, idx) in item.value" :key="idx" style="margin: 5px 0;position: relative">
            ...
            <div class="wetuc-block">
                <el-form-item label=" ">
                    <div class="wetuc-input-col943" style="display: flex;justify-content: center;align-content: center;align-items: center">
                ...
                <div v-for="(item, index) in hostAntiData">
                    <div style="display: inline-block;position: relative;" v-if="item.type === 'danh'">
                        <el-form-item>
                            <el-input class="wetuc-input-col943" placeholder="单行文本" v-model="item.key"></el-input>
                            <el-checkbox v-model="item.must" style="position: absolute;right: 0">必填</el-checkbox>
                            <i class="el-icon-delete red" style="position: absolute;right: -70px;top: 15px;cursor:pointer;" @click.prevent="enterpriseDeteleOptions(1,index)">删除</i>
                        </el-form-item>
                    ...
                    <div style="display: inline-block;position: relative" v-if="item.type === 'danx'">
                        ...
                        <div v-for="(val, idx) in item.value" :key="idx" style="margin: 5px 0;position: relative">
                            <el-input v-model="item.value[idx]" placeholder="单选项" class="wetuc-input-col943"></el-input>
                            <i class="el-icon-edit" style="position: absolute;right: -70px;top: 15px;cursor:pointer;" @click.prevent="enterpriseAddOptions(item.value)" v-if="idx === 0">添加选项</i>
                            <i class="el-icon-delete red" style="position: absolute;right: -70px;top: 15px;cursor:pointer;" @click.prevent="enterpriseDeteleOptions(2,idx)" v-else>删除</i>
                        </div>
                        <i class="el-icon-delete red" style="position: absolute;right: -70px;top: 15px;cursor:pointer;" @click.prevent="enterpriseDeteleOptions(1,index)">删除</i>
                    </div>
                    <div style="display: inline-block;position: relative" v-if="item.type === 'duox'">
            ...
            <div class="wetuc-block">
                <el-form-item label=" " >
                    ...
                    <el-button type="primary" @click.prevent="submitForm('pageInfo', 3)">保存到草稿</el-button>
