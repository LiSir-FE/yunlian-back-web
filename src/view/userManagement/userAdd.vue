    ...
    <div class="wetuc-page-content">
        ...
        <el-form ref="pageInfo" :model="pageInfo" :inline="true" label-width="100px" :rules="rules">
            ...
            <el-form-item label="联系方式" prop="phone">
                <el-input v-model="pageInfo.phone" placeholder="请输入联系方式" class="wetuc-input-col2"></el-input>
            </el-form-item>
            ...
            <el-form-item label="公司" prop="companies">
                ...
                <el-tooltip class="item" effect="dark" content="没有找到?新增公司" placement="top-start">
                    <i class="el-icon-info" @click="addCompany"></i>
                </el-tooltip>
            </el-form-item>
            ...
            <el-form-item label=" ">
                <el-button type="primary" @click="submitForm('pageInfo', 1)">提交</el-button>
                <el-button type="primary" @click="submitForm('pageInfo', 2)">提交并新增工作</el-button>
...
export default {
    data() {
        ...
        return {
            ...
            rules: {
                ...
                intJob: [
                    {type: 'array', required: true, message: '请选择职能', trigger: ['blur', 'change']}
                ],
                detailAddress: [
    ...
    methods: {
        ...
        addCompany() {
            this.$store.commit('setAddCompanyUrl', '/userAdd');
            this.$store.commit('setAddCompanyName', '新增用户');
