    ...
    <div class="wetuc-page-content">
        ...
        <el-form ref="pageInfo" :model="pageInfo" :inline="true" label-width="100px" :rules="rules">
            ...
            <el-form-item label="一级行业" prop="industry">
                <el-select v-model="pageInfo.industry" placeholder="请选择一级行业" class="wetuc-input-col2" @change="industryChange(pageInfo.industry, true)">
                    <el-option
            ...
            <el-form-item label="营销顾问" prop="marketing">
                <el-select v-model="pageInfo.marketing" value-key="id" placeholder="请选择员工" class="wetuc-input-col2">
                    <el-option
            ...
            <el-form-item label="媒体顾问" prop="media">
                <el-select v-model="pageInfo.media" value-key="id" placeholder="请选择员工" class="wetuc-input-col2">
                    <el-option
            ...
            <el-form-item label="行业顾问" prop="industryConsultant">
                <el-select v-model="pageInfo.industryConsultant" value-key="id" placeholder="请选择员工" class="wetuc-input-col2">
                    <el-option
        ...
        <el-table :data="tableData" style="width: 100%" v-loading="tableLoading" element-loading-text="拼命加载中">
            ...
            <el-table-column :key="Math.random()" prop="phone" label="联系方式" min-width="100" show-overflow-tooltip v-if="activeName === 'a'">
                <template slot-scope="scope">
                    {{scope.row.phone || (scope.row.phone).substr(0, 3) + '****' + (scope.row.phone).substr(7)}}
                </template>
            </el-table-column>
            ...
            <el-table-column :key="Math.random()" prop="activityTitle" label="标题" min-width="150" show-overflow-tooltip v-if="activeName === 'b' || activeName === 'c'"></el-table-column>
...
<!--                <template slot-scope="scope">-->
<!--                    <el-button type="text" icon="el-icon-view" size="small">详情</el-button>-->
<!--                </template>-->
<!--            </el-table-column>-->
        </el-table>
        ...
        <el-dialog :title="dialogTitle" :visible.sync="dialogVisible">
            ...
            <el-table ref="dialogtableData" :data="dialogtableData" style="width: 100%" @selection-change="dialogSelectionChange">
                <el-table-column :key="Math.random()" type="selection" width="55"></el-table-column>
                <el-table-column :key="Math.random()" prop="id" label="ID" min-width="120" show-overflow-tooltip></el-table-column>
                <el-table-column :key="Math.random()" prop="summary" label="摘要内容" min-width="100" show-overflow-tooltip v-if="activeName === 'b'"></el-table-column>
                <el-table-column :key="Math.random()" prop="activityTitle" label="标题" min-width="100" show-overflow-tooltip v-if="activeName === 'c'"></el-table-column>
                <el-table-column :key="Math.random()" prop="createDate" label="时间" min-width="100" show-overflow-tooltip v-if="activeName === 'b'">
                    <template slot-scope="scope">
                        {{scope.row.createDate | stampFormate4}}
                    </template>
                </el-table-column>
                <el-table-column :key="Math.random()" prop="publishTime" label="时间" min-width="100" show-overflow-tooltip v-if="activeName === 'c'">
                    <template slot-scope="scope">
                        {{scope.row.publishTime | stampFormate4}}
                    </template>
                </el-table-column>
                <el-table-column :key="Math.random()" min-width="80" label="操作" fixed="right">
                    <template slot-scope="scope">
...
export default {
    ...
    methods: {
        ...
        queryData(name) {
            ...
            const type = name === 'a' ? 1 : name === 'b' ? 2 : name === 'c' ? 3 : name === 'd' ? 4 : name === 'e' ? 5 : ''
