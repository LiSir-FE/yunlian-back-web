    ...
    <div class="wetuc-page-content">
        <div class="breadcrumb-con">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item>修改车队</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        ...
        <el-form ref="pageInfo" :model="pageInfo" label-width="100px" :inline="true" :rules="rules">
            ...
            <el-collapse v-model="activeNames" accordion @change="handleChange">
                <el-collapse-item name="a">
                    ...
                    <el-button type="primary" @click.prevent="twoSubmit(versionList)" style="margin: 10px 0 15px 1%;display: block">提 交</el-button>



                    <div v-for="(items, index) in carTeamLines" style="display: block">
                        ...
                        <el-button type="text" @click.prevent="addCustomer" v-if="index == 0">添加</el-button>
                        <el-button type="text" @click.prevent="lineSubmit(items)" v-if="!items.disAbled">保存</el-button>
                        <el-button type="text" class="red" @click.prevent="removeCustomer(items, index)"
                                   v-if="index !== carTeamLines.length - 1">删除
                        </el-button>
                    </div>
                </el-collapse-item>
            </el-collapse>
